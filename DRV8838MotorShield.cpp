#include "DRV9939MotorShield.h"

// Constructors ////////////////////////////////////////////////////////////////
//all default pins function (note: motor sheild 2 is "custom")
DRV9939MotorShield::DRV9939MotorShield()
{
...
DRV9939MotorShield::DRV9939MotorShield(unsigned char INA3, unsigned char INB3, unsigned char EN3DIAG3, unsigned char CS3, unsigned char PWM3, unsigned char INA4, unsigned char INB4, unsigned char EN4DIAG4, unsigned char CS4, unsigned char PWM4)
{
  //default Pin map motor sheild 1
  _INA1 = 2;
  _INB1 = 4;
...
DRV9939MotorShield::DRV9939MotorShield(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, unsigned char INA2, unsigned char INB2, unsigned char EN2DIAG2, unsigned char CS2, unsigned char INA3, unsigned char INB3, unsigned char EN3DIAG3, unsigned char CS3, unsigned char INA4, unsigned char INB4, unsigned char EN4DIAG4, unsigned char CS4)
{
  //Pin map
...
DRV9939MotorShield::DRV9939MotorShield(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char CS1, unsigned char INA2, unsigned char INB2, unsigned char EN2DIAG2, unsigned char CS2, unsigned char INA3, unsigned char INB3, unsigned char EN3DIAG3, unsigned char CS3, unsigned char INA4, unsigned char INB4, unsigned char EN4DIAG4, unsigned char CS4, unsigned char PWM1, unsigned char PWM2, unsigned char PWM3, unsigned char PWM4)
{
...
void DRV9939MotorShield::setM1Speed(int speed)
{
...
void DRV9939MotorShield::setM2Speed(int speed)
{
  unsigned char reverse = 0;
...
void DRV9939MotorShield::setM3Speed(int speed)
{
  unsigned char reverse = 0;
...
void DRV9939MotorShield::setM4Speed(int speed)
{
  unsigned char reverse = 0;
...
void DRV9939MotorShield::setSpeeds(int m1Speed, int m2Speed,int m3Speed, int m4Speed)
{
  setM1Speed(m1Speed);
  setM2Speed(m2Speed);
  setM3Speed(m3Speed);
...
void DRV9939MotorShield::setM1Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void DRV9939MotorShield::setM2Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void DRV9939MotorShield::setM3Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void DRV9939MotorShield::setM4Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void DRV9939MotorShield::setBrakes(int m1Brake, int m2Brake, int m3Brake, int m4Brake)
{
  setM1Brake(m1Brake);
  setM2Brake(m2Brake);
  setM3Brake(m3Brake);
...
unsigned int DRV9939MotorShield::getM1CurrentMilliamps()
{
...
unsigned int DRV9939MotorShield::getM2CurrentMilliamps()
{
  // extra insurance for the analog read function, must be an input
  pinMode(_CS2,INPUT);
  // 5V / 1024 ADC counts / 144 mV per A = 34 mA per count
...
unsigned int DRV9939MotorShield::getM3CurrentMilliamps()
{
  // extra insurance for the analog read function, must be an input
  pinMode(_CS3,INPUT);
  // 5V / 1024 ADC counts / 144 mV per A = 34 mA per count
...
unsigned int DRV9939MotorShield::getM4CurrentMilliamps()
{
  // extra insurance for the analog read function, must be an input
  pinMode(_CS4,INPUT);
  // 5V / 1024 ADC counts / 144 mV per A = 34 mA per count
...
unsigned char DRV9939MotorShield::getM1Fault()
{
  return !digitalRead(_EN1DIAG1);
}

// Return error status for motor 2 
unsigned char DRV9939MotorShield::getM2Fault()
{
  return !digitalRead(_EN2DIAG2);
}

// Return error status for motor 3 
unsigned char DRV9939MotorShield::getM3Fault()
{
  return !digitalRead(_EN3DIAG3);
}

// Return error status for motor 4 
unsigned char DRV9939MotorShield::getM4Fault()
{
